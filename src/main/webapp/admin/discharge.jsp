...
<html>
<head>
    <title>Discharge Summary - HealthSync</title>
...
<div class="welcome">
    <i class="bi bi-door-open"></i> Discharge Summary &nbsp;|&nbsp;
...
<div class="container">
    ...
    <div class="table-box">
        <div class="table-title">
            <i class="bi bi-door-open"></i> Discharged Patients
        </div>
        <table>
            <tr>
                <th>ID</th><th>Date & Time</th><th>Name</th>
                <th>Gender</th><th>Age</th><th>Total Fees</th><th>Phone</th>
            </tr>
            <%
                try {
                    Connection con = DBConnection.getConnection();
                    PreparedStatement pts = con.prepareStatement("SELECT * FROM roo_backup");
                    ResultSet rs = pts.executeQuery();
                    while(rs.next()) {
            %>
            <tr>
                <td><%= rs.getString("id") %></td>
                <td><%= rs.getString("deleted_at") %></td>
