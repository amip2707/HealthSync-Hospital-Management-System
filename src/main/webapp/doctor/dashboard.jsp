...
<body>
    ...
    <p class="section-title">Doctor Panel</p>
    <div class="cards">
        <a href="${pageContext.request.contextPath}/appointment" class="card green">
            <div class="icon"><i class="bi bi-calendar-check"></i></div>
            <h3>My Appointments</h3>
            <p>View Schedule</p>
        </a>
        <a href="${pageContext.request.contextPath}/doctor/prescription.jsp" class="card blue">
            <div class="icon"><i class="bi bi-capsule"></i></div>
            <h3>Prescriptions</h3>
            <p>Write & View</p>
        </a>
        <a href="${pageContext.request.contextPath}/doctor/view-patients.jsp" class="card orange">
