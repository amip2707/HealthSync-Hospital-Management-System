...
<div class="welcome">
    <i class="bi bi-clipboard2-pulse"></i> Patient Records &nbsp;|&nbsp;
...
<div class="container">
    ...
    <div class="table-box">
        <div class="table-title">
            <i class="bi bi-clipboard2-pulse"></i> Records for  <%= docname %>
        </div>
        <table>
            <tr>
                <th>ID</th><th>Date</th><th>Name</th><th>Gender</th>
                <th>Blood</th><th>Problem</th><th>Weight</th><th>Height</th>
                <th>Plans</th><th>Phone</th>
            </tr>
            <%
                try {
                    Connection con = DBConnection.getConnection();
                    PreparedStatement pts = con.prepareStatement(
                        "SELECT * FROM patientrecords WHERE doc_name=?");
            ...
            <tr>
                ...
                <td><%= rs.getString("rgender") %></td>
                <td><%= rs.getString("rblood") %></td>
                <td><%= rs.getString("rproblem") %></td>
                <td><%= rs.getString("rweight") %></td>
                <td><%= rs.getString("rheight") %></td>
                <td><%= rs.getString("rplans") %></td>
                <td><%= rs.getString("rphone") %></td>
            </tr>
