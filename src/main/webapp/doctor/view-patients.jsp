...
<%
    ...
    List<Patient> patientList = dao.getPatientsByDoctor(docname);
%>
<!DOCTYPE html>
<html>
<head>
    <title>My Patients - HealthSync</title>
...
<div class="container">
    ...
    <div class="table-box">
        <div class="table-title">
            <i class="bi bi-people"></i> Patients of  <%= docname %>
        </div>
        <table>
            <tr>
                <th>ID</th><th>Date</th><th>Name</th><th>Gender</th>
                <th>Blood</th><th>Sugar</th><th>Pressure</th><th>Phone</th><th>Address</th>
            </tr>
