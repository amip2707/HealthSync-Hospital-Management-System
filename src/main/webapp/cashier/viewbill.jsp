...
<html>
<head>
    <title>View Bills - HealthSync</title>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        td{
            padding:11px 10px;border-bottom:1px solid #C9CAD9;font-size:13px;
        }
        tr:hover{background:#D1D2F9;}
        .total-cell{
            background:#D1D2F9;font-weight:800;color:#0077b6;
        }
    </style>
</head>
...
<div class="navbar">
    ...
    <div class="nav-links">
        <a href="${pageContext.request.contextPath}/cashier/dashboard.jsp" class="nav-btn">
...
<div class="welcome">
    <i class="bi bi-table"></i> All Bill Transactions &nbsp;|&nbsp;
...
<div class="container">
    <div class="table-box">
        <div class="table-title">
            <i class="bi bi-receipt"></i> All Bills History
        </div>
        ...
        <table>
            ...
            <tr>
                ...
                <td><b><%= b.getName() %></b></td>
                <td><%= b.getDoc_fees() %></td>
                <td><%= b.getRoom_fees() %></td>
                <td><%= b.getExtra_fees() %></td>
                <td class="total-cell">₹ <%= b.getTotal_fees() %></td>
            </tr>
            <% } } else { %>
            <tr>
