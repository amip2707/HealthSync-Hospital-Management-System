...
<html>
<head>
    <title>Pharmacy - Doctor Prescriptions</title>
...
<div class="welcome">
    <i class="bi bi-capsule"></i> Doctor Prescriptions &nbsp;|&nbsp;
...
<div class="container">
    ...
    <div class="table-box">
        <div class="table-title">
            <i class="bi bi-clipboard2-pulse"></i> Doctor Prescriptions
        </div>
        <table>
            <tr>
                <th>ID</th>
