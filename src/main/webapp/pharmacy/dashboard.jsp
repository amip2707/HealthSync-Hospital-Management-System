...
<html>
<head>
    <title>Pharmacy Dashboard - HealthSync</title>
...
<body>
    ...
    <p class="section-title">Pharmacy Panel</p>
    <div class="cards">
<a href="${pageContext.request.contextPath}/pharmacy/prescriptions.jsp" class="card">
            <div class="icon"><i class="bi bi-capsule"></i></div>
            <h3>Prescriptions</h3>
            <p>View All</p>
        </a>
        <a href="${pageContext.request.contextPath}/pharmacy/prescription-orders.jsp" class="card orange">
