...
<head>
 ...
 .logout-btn {
       ...
       .logout-btn:hover {
        ...
        .welcome {
            background:#D1D2F9; color:#6C63FF;
            padding:12px 30px; font-size:14px; font-weight:600;
            border-bottom:2px solid #A3BCF9;
        }
        .section-title {
            padding:30px 30px 10px; font-size:18px;
            font-weight:700; color:#2D2D2D;
            border-left:4px solid #6C63FF; margin-left:30px;
        }
        .cards {
        ...
        .card {
            ...
            padding:28px 20px; width:175px; text-align:center;
            box-shadow:0 4px 15px rgba(108,99,255,0.1);
            cursor:pointer; transition:all 0.3s;
            text-decoration:none; color:#2D2D2D;
            border-top:4px solid #6C63FF;
        }
        .card:hover { transform:translateY(-8px); box-shadow:0 8px 25px rgba(108,99,255,0.2); }
        .card .icon { font-size:38px; margin-bottom:12px; color:#6C63FF; }
...
<body>
    ...
    <p class="section-title">Patient Panel</p>
    <div class="cards">
        <a href="${pageContext.request.contextPath}/patient/book-appointment.jsp" class="card blue">
            <div class="icon"><i class="bi bi-calendar-plus"></i></div>
            <h3>Book Appointment</h3>
            <p>Schedule Visit</p>
        </a>
        <a href="${pageContext.request.contextPath}/patient/my-records.jsp" class="card green">
            <div class="icon"><i class="bi bi-clipboard2-pulse"></i></div>
            <h3>My Records</h3>
            <p>Medical History</p>
        </a>
        <a href="${pageContext.request.contextPath}/patient/my-bills.jsp" class="card orange">
